suite("Base",function()
{
    ...
    suite("store and load options", function ()
    {
        setup(function ()
        {
            localStorage = {}
    ...
    suite("tips",function(){
        ...
        test("title : lvl*8 above lvl names length", function ()
        {
        ...
        test("other : nick + mute", function ()
        {
            ...
            expect(nerthus.tips.other(other)).equal(`<b>${other.nick}</b><img src=img/mute.gif>`)
        })
