...
// are they needed/wanted?
    ...
    test("run when there is no command", function ()
    {
    ...
    test("run when there is a command, but not a callback", function ()
    {
        const fetch_cmd = nerthus.chatCmd.fetch_cmd
    ...
    test("run when there is a command and callback which hides msg", function ()
    {
        const fetch_cmd = nerthus.chatCmd.fetch_cmd
        nerthus.chatCmd.fetch_cmd = (ch) =>
        {
    ...
    test("run when there is a command and callback which doesn't hide msg", function ()
    {
        const fetch_cmd = nerthus.chatCmd.fetch_cmd
        nerthus.chatCmd.fetch_cmd = (ch) =>
        {
    ...
    test("fetch callback public map - not nar", () =>
    {
        ...
        nerthus.isNarr = nerthus.isRad = nerthus.isSpec = () =>
        {
            return false
        }
