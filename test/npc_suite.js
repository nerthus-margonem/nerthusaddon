suite("Npc", function ()
{
    ...
    {
        suite("npc dialog parse message", function ()
        {
        ...
        suite("npc dialog parse replies", function ()
        {
        ...
        suite("npc dialog placeholders", function ()
        {
    ...
    suite("date and time", function ()
    {
        ...
        function npc_expected_in_time(npc_time, current_time)
        {
        ...
        function npc_not_expected_in_time(npc_time, current_time)
        {
            var _date = setTime(current_time.split(":")[0], current_time.split(":")[1])
        ...
        suite("time", function ()
        {
            ...
            suite("npc time with minutes", function ()
            {
        ...
        suite("date", function ()
        {
            ...
            suite("date formats", function ()
            {
                ...
                function npc_expected_in_date(npc_date, current_date)
                {
                    const _date = setDate(current_date[0], current_date[1], current_date[2])
                ...
                function npc_not_expected_in_date(npc_date, current_date)
                {
                    const _date = setDate(current_date[0], current_date[1], current_date[2])
                ...
                suite("DD.MM.YYYY-DD.MM.YYYY", function ()
                {
