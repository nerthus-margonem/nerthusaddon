...
describe("maps", function () {
  ...
  describe("applyCurrentMapChange()", function () {
    beforeEach(function () {
      ...
      injectors.utilityFunctions.resolveUrl =
        sinon.fake.returns("resolved-url");
    });
    ...
    it("should not change anything when no custom map defined", function () {
      ...
      if (INTERFACE === "SI") {
        ...
        expect(
          injectors.cssManager.removeCustomStyle.calledWith(
    ...
    it("should change map when there is custom map in current season", function () {
      ...
      if (INTERFACE === "SI") {
        ...
        expect(
          injectors.cssManager.changeCustomStyle.calledWith(
            "map-background-image",
            `#ground {
